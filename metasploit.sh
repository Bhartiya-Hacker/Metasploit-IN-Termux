...
sleep 1
echo -e "[${Green}+${clear}] Follow the video shared in ${Yellow}t.me/BhartiyaHacker${clear}"
sleep 1
cd $HOME
...
sleep 3
echo -e "[${Yellow}+${clear}] Press 'Y' if Asked..."
sleep 3
clear
...
#-------------------------------------------------------------------------#
#  Script edited by BhartiyaHacker created by |b|y| |G|u|s|h|m|a|z|u|k|o| #
#-------------------------------------------------------------------------#
...
echo -e "[${Green}+${clear}] Watch full video to fix ${Blue}Link https://youtube.com/c/BhartiyaHacker"
echo -e "[${Green}+${clear}] Join for updates ${Blue}Link https://t.me/BhartiyaHacker"
